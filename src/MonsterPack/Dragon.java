...
public class Dragon extends Monster {
    public Dragon(String name, int maxHP, int hp, int maxMana, int mana, int attack, int defense, int critChance, int critDamage, int dodgeChance) {
    ...
    public int basicAttack(int monsterAttack, int monsterCritChance, int monsterCritDamage, int heroDefense, int heroDodge, String heroName) {
        ...
        if (critOrDodge > 90) {
            ...
            System.out.printf("The \033[0;33m%s\033[0m attacked with its claws for a Crit Strike and inflicted \033[0;31m%.0f damage(s)\033[0m to \033[0;34m%s\033[0m!\n\n", name, damages, heroName);
            ...
            System.out.printf("The \033[0;33m%s\033[0m blows fire and inflicts \033[0;31m%.0f damage(s)\033[0m to \033[0;34m%s\033[0m.\n\n", name, damages, heroName);
        }
